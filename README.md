...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/kayleeghiuzelian-elitetreasuresclubshop)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/kayleeghiuzelian-elitetreasuresclubshop
```

A live public deployment of this template is available at [https://kayleeghiuzelian-elitetreasuresclubshop.templates.workers.dev](https://kayleeghiuzelian-elitetreasuresclubshop.templates.workers.dev)
